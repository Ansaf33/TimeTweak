...
import 'package:time_tweak/screens/about.dart';
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if(CurrentUserData.role == Role.cr) _buildSecondaryPage(
                        sw,
                        context,
                        "Rescheduling",
                      ...
                      if(CurrentUserData.role != Role.faculty) _buildSecondaryPage(
                        sw,
                        context,
                        "Appointments",
                        Icons.list_alt,
    ...
    return ListTile(
      ...
      onTap: () async {
        ...
        if (value != itemValue) {
          Navigator.of(
            context,
          ).pushAndRemoveUntil(_slideNewpage(page), (route) => route.isFirst);
