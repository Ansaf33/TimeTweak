...
class CRSignUpScreen extends StatelessWidget {
  ...
  static final TextEditingController _usrnameCtrl = TextEditingController();
  static final TextEditingController _rollNumCtrl = TextEditingController();
  ...
  _verifyValues(String username, String rollnum, String passwd) async {
    ...
    try {
      ...
      final (res, msg) = await ClassRepService.newCR(
        crData:
            ClassRep(
              regNo: rollnum,
      ...
      if (!res) {
        ...
        ClassRep.fromJson(msg).setAsCurrentUserData();
        Loading.close();
